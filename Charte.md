## 📜 CHARTE IDÉOLOGIQUE – BASE
## 1. Nature de BASE

BASE est une unité d’échange universelle distribuée par un protocole ouvert.
Elle n’est ni une aide sociale, ni un produit financier, ni une promesse de rendement.

BASE est un droit monétaire d’usage, accordé à toute personne qui active et respecte le protocole.
...
d’échanger des biens et des services
...
une réduction progressive des droits

une suspension

ou une réaffectation des fonds au système collectif

BASE ne finance pas l’abandon durable ou l’accumulation passive.

## 4. Usage avant accumulation

BASE est conçue pour être :
...
L’accumulation sans usage n’est ni encouragée ni récompensée.

La valeur de BASE provient de son utilisation réelle, non de la spéculation.

## 5. Fonds bloqués et contribution collective

Une partie de BASE peut être volontairement ou mécaniquement bloquée.
...
des projets d’utilité collective

des biens communs

des services essentiels

Chaque utilisateur peut choisir où orienter sa contribution.

## 6. Gouvernance et protocole

BASE est gouvernée par :
...
Les décisions critiques peuvent inclure :

des votes pondérés

une validation humaine

des garde-fous protocolaires

BASE privilégie la stabilité, la transparence et la prudence à la croissance rapide.

## 7. Économie réelle

BASE a vocation à être utilisée pour :

des biens réels

des services concrets

des échanges locaux ou mondiaux

Elle peut coexister avec :
...
BASE n’impose aucun abandon monétaire.

## 8. Travail, liberté et avenir

BASE ne vise pas à supprimer le travail.
Elle vise à libérer le choix.

Elle permet :

de refuser l’exploitation

de valoriser les activités non marchandes

de soutenir la création, la recherche, l’entraide

Dans un monde de plus en plus automatisé, BASE anticipe une économie où la valeur n’est plus uniquement liée à l’emploi.

## 9. Limites et humilité
...
garantir la prospérité individuelle

BASE est un outil.
Son impact dépendra de son usage collectif.
...
ne pas forcer l’adhésion

ne pas collecter d’identité

ne pas exclure arbitrairement
